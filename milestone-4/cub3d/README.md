...
> [!NOTE]
> This project has been ported to the **Nintendo 3DS** (yes, really). Check out
> [3DS_README.md](./3DS_README.md) for build instructions and technical details.
...
We take inspiration from the Doom naming convention. The files are placed in a
subdir that correspond to their subject, and are given a prefix for their
subject, and a suffix for their context (mandatory, bonus, extra).
...
**This project was inspired by these awesome videos !** They helped us
understand the many concepts of graphical 2.5D and 3D rendering, so check them
out ! I watched all of them on the bus while going to school. They are
