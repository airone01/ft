...
/**
 * Picks the best target in stack A for the given index of an element in stack
 * B. First tries to place B element between A elements by finding an A element
 * with bigger index. If not possible, finds element with smallest index in A.
 * @param   stack_a     Stack A
 * @param   b_idx       Index of Stack B element
