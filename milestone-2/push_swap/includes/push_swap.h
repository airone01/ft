...
void ss(t_stack *stack_a, t_stack *stack_b, unsigned long display);
void pa(t_stack **stack_a, t_stack **stack_b, unsigned long display);
void pb(t_stack **stack_a, t_stack **stack_b, unsigned long display);
void ra(t_stack **stack_a, unsigned long display);
void rb(t_stack **stack_b, unsigned long display);
void rr(t_stack **stack_a, t_stack **stack_b, unsigned long display);
void rra(t_stack **stack_a, unsigned long display);
void rrb(t_stack **stack_b, unsigned long display);
void rrr(t_stack **stack_a, t_stack **stack_b, unsigned long display);
...
void move(t_stack **stack_a, t_stack **stack_b, long cost_a, long cost_b);
