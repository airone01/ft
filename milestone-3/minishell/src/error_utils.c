...
void init_file_cmd_errors(t_error_info *error_table) {
  ...
  error_table[ERR_NO_PWD] =
      (t_error_info){1, "failed to get current directory"};
...
void init_env_errors(t_error_info *error_table) {
  ...
  error_table[ERR_VLD_ENV_VAR_EMPTY] = (t_error_info){1, "empty variable name"};
  error_table[ERR_VLD_ENV_VAR_START] =
      (t_error_info){1, "variable name must start with letter or _"};
  error_table[ERR_VLD_ENV_VAR_BAD_CHAR] =
      (t_error_info){1, "invalid character in variable name"};
  error_table[ERR_VLD_ENV_VAR_TOO_LONG] =
      (t_error_info){1, "variable name too long"};
...
void init_validation_errors(t_error_info *error_table) {
  error_table[ERR_VLD_INPUT_LENGTH] =
      (t_error_info){1, "input exceeds maximum length"};
  error_table[ERR_VLD_REDIR_FILENAME_EMPTY] =
      (t_error_info){1, "empty filename"};
  error_table[ERR_VLD_REDIR_FILENAME_TOO_LONG] =
      (t_error_info){1, "filename too long"};
  ...
  error_table[ERR_TOKEN_LIST] = (t_error_info){1, "failed to build token list"};
}
